...
class MacroPad {
    ...
    BindHotkeys() {
        loop 10 {
            ...
            Hotkey(keyName, ObjBindMethod(this, "HandleMacro", A_Index - 1))
        }
        Hotkey("*NumpadAdd", ObjBindMethod(this, "NextLayer"))
        Hotkey("*NumpadSub", ObjBindMethod(this, "PrevLayer"))
        Hotkey("*NumpadDot", ObjBindMethod(this, "ShowHoldOverlay"))
        Hotkey("*NumpadDel", ObjBindMethod(this, "ShowHoldOverlay"))
        Hotkey("*NumpadDot Up", ObjBindMethod(this, "HideHoldOverlay"))
        Hotkey("*NumpadDel Up", ObjBindMethod(this, "HideHoldOverlay"))
    }
